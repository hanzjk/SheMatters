                                    ...
                                    <nav class="main-menu navbar-expand-xl navbar-dark">
                                        ...
                                        <div class="collapse navbar-collapse">
                                            <ul class="navigation">
                                                ...
                                                <li class="current"><a href="raiseAwarness.php">Raise Awarness</a></li>
            ...
            <div class="auto-container">
                <div class="wrapper-box">
                    ...
                    <div class="mobile-menu style-one">
                        <div class="menu-box">
                            <div class="logo"><a href="index-2.html"><img src="../assets/main/images/logo2.png"  style="height: 80px;" alt=""></a></div>
                            <!-- Main Menu -->
                            <nav class="main-menu navbar-expand-xl navbar-dark">
