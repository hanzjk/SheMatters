                ...
                <div class="container" id="page1">
                    <ul class="nav page-navigation" id="page-navigation">
                        ...
                        <li class="nav-item" id="link2">
                            ...
                            <div class="submenu">
                                <ul>
                                    <li class="nav-item"><a class="nav-link" href="lodged_complaints.php">My Complaints</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="submenu">
                                <ul>
                                    <li class="nav-item"><a class="nav-link" href="../financial_aid/my_applications.php">My Applications</a></li>
                                </ul>
                            </div>
                        </li>
