...
<button class="btn btn-success col-12" data-toggle="modal" data-target="#myModal" >Accept Complaint </button> 
</div>
<div class="row"><br></div>
<div class="row mx-auto">
<button class="btn btn-danger col-12" data-toggle="modal" data-target="#myModal1">Reject Complaint </button>
</div>
        </div>
</div>
    ...
    <div class="modal-dialog modal-confirm ">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <h4>Are you sure ?</h4>
                <p>Do you want to accept the complaint ? This process cannot be undone</p>
                <a href="accept.php?complaint_id=<?php echo $row['complaint_id'] ?>"><button class="btn btn-success" style="background-color:#01796f;">Accept</button></a>
...
<div id="myModal1" class="modal fade col-12">
    <div class="modal-dialog modal-confirm">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <h4>Are you sure ?</h4>
                <p>Do you really want to reject this complaint ? This process cannot be undone</p>
                <a href="reject.php?complaint_id=<?php echo $row['complaint_id'] ?>"><button class="btn " style="background-color: #800020;">Reject</button></a>
                <button class="btn btn-light"data-dismiss="modal">Cancel</button>
            </div>
        </div>
    </div>
