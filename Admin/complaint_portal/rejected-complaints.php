...
$tot = "SELECT  COUNT(complaint_id)  FROM complaints WHERE  state='Rejected'";
...
<div class="row " style="margin-top: -10px;">
  ...
  <div class="mt-2 mb-2">
      <span  style="font-size: 20px;font-weight: bold;"><i class="fa fa-times-circle-o" aria-hidden="true"></i> &nbsp;Rejected Complaints (<?php echo $InqTot?>)</span>
  <span class="float-right">Complaint Portal &nbsp;&nbsp; <i class="fa fa-arrow-right" aria-hidden="true"></i>  &nbsp;&nbsp;Rejected Complaints</span>
  </div>
</div>
</div>
<div class="row mt-3" style="background-color:#fff;  border: 1px solid #e8eef1;">
    ...
    <div class="col-12 mx-auto table-responsive comp">
<br>
        <!--Main Content-->
        <table id="myTable" class="table table-hover text-center table-striped ">
            ...
            $sql = "SELECT complaint_id,title,created_at FROM complaints WHERE state='Rejected' ";
            ...
            ?>
                ...
                <tr>
                    ...
                    <button class="btn btn-info btn-sm" > View&nbsp;<i class="fa fa-info-circle" aria-hidden="true"></i></button>
                   </a>&nbsp;&nbsp;
