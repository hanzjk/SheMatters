    ...
    <div class="container1-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#" aria-expanded="false" aria-controls="ui-basic3">
            ...
            <div class="collapse" id="ui-basic3">
              ...
              <li class="nav-item" > <a class="nav-link" href="home_complaints.php">&nbsp;&nbsp;Home</a></li>
              <li class="nav-item"> <a class="nav-link" href="pending-complaints.php">&nbsp;&nbsp;New Complaints</a></li>
              <li class="nav-item"> <a class="nav-link" href="ongoing-complaints.php">&nbsp;&nbsp;Ongoing Complaints</a></li>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic5" aria-expanded="false" aria-controls="ui-basic5">
              ...
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="../users.php">&nbsp;&nbsp;Registered Users</a></li>
