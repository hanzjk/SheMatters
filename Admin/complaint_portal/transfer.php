...
<div class="">
    ...
    <div class="row " style="margin-top: -10px;">
        ...
        <div class="col-12 card comp " style="outline: none;border: none;">
            ...
            <div class="mt-2 mb-2">
                <span style="font-size: 20px;font-weight: bold;"><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i> &nbsp;Transfer The Complaint</span>
                <span class="float-right">Complaint Portal &nbsp;&nbsp; <i class="fa fa-arrow-right" aria-hidden="true"></i> &nbsp;&nbsp;Transfer</span>
            </div>
        </div>
    </div>
    <br>

    <div class="card comp mx-0" style="outline: none;border: none;">

        <div class="row mt-3 ">


            <div class="mapsl col-lg-4 ml-2 mr-2 ">
                <br>
                <?php
                 ?>
                <svg baseprofile="tiny" fill="#7c7c7c" width=auto id="slmap" height=auto stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" version="1.2" viewbox="0 0 1000 1745" width="1000" xmlns="http://www.w3.org/2000/svg">
                    <a xlink:Title="Nuwara">
                        <path d="M598.3 1048.7l3.9 67.3 9.7 32.2-0.8 14.5-11.9 11.1-9.5 2.7-5.6 3.4-18.3-3.8-18.9 2.9-16.2-1.3-10.2-16.1-3.8-0.4-4.6-1.7-6.3-8.5-7.7-6.9 1.4 12.9 4 16.7-8.9 15.2-28.5 33.7-7.5-2-8.7 0.2-12.8 8.9-9 2-15.9-2-10 8 3.6-1.1 3.4 1.5 7.8 14.4 6.6 6.2 5.2 7.2-5.3 14.9-9.5 10.2-12.9-7.7-19.8-29.5-12.6-1.1 0.2-8.9 3.2-6.8-3.2-5.6-6.7-16 5-4.7 15.3-2.5 7-7.5 4.8-0.3 4.8-1.2 3.5-5.4 2.5-5.9-5.2-6.5-6.4-6.3-0.1-6.6 1.1-7.9-5.3-6.5-11.3-6.3-3.7-2.6 0.7-8.6-19.1-16.8-5.4-13.6 9.1 1 8-2.4-0.8-2-0.3-3 1.5-2.6 1.9-2.4 1.4-8.9 6.3 0 6.9 4.9 7.5 0.6 0.7-4.7-0.7-4.9 6.5-3.7 6.3 1.1 4.8-2.2-2.7-6.1-3.5-5.6 5.2-1.4 5.3-2.5 9.1 12.6 28 17.6 16.3 1 9.4-10.5-1.5-16.3 2.7-7 6.1-3.7 6.6 2.5 16.4 13.6 12.7-1.9 14-11.5 18.2 0.1 7.3-3.6 5.3 6.7 3.2-1.8 2.9-2.5 4.9-8.2 8.9-1.4 14 1.6z" id="Nuwara" name="Nuwara">
                        </path>
                    </a>

                    <a xlink:Title="Matale">
            ...
            <div class="col-lg-7 mt-3 ">
                <span style="font-size: 20px;font-weight: normal;text-transform:uppercase">&nbsp; <?php echo $district ?> District </span>
                ...
                <div class="col-lg-11">
                    ...
                    <table id="myTable" class="table table-hover text-center table-striped ">
                        ...
                        $sql = "SELECT police_name,police_id FROM police_users WHERE police_district='" . $district . "'";
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#" style="text-decoration: none;">
                                        ...
                                        <button class="btn btn-info mr-4 myModal_a" data-toggle="modal" data-target="#myModal" data-pid="<?php echo $row['police_id'] ?>" data-cid="<?php echo $complaint_id ?>"> Transfer&nbsp;<i class="fa fa-arrow-right" aria-hidden="true"></i></button>
                                    </a>
                                ...
                                <div id="myModal" class="modal fade col-12">
                                    <div class="modal-dialog modal-confirm ">
                                        <div class="modal-content">
                                            <div class="modal-header justify-content-center" style="background-color: #cd5700;">
                                                <div class="icon-box1">
                                                    <i class="fa fa-question-circle"></i>
                                                </div>
                                            </div>
                                            <div class="modal-body text-center">
                                                <h4>Plase confirm the transference   </h4>
                                                <form action="transfer_action.php"  method="get">
                                                <input id="complaint" style="display: none;" name="cid">
                                                <input id="police_id" style="display: none;" name="pid">

                                      
                                             <input type="submit" 
                                               class="btn btn-warning" style="background-color:#b7410e;" value="Transfer" >
                                            </form>
...
<script>
    $(document).ready(function() {
        var d = <?php echo $district ?>;
        $(d).css("fill", "rgb(13,22,100)");
    });
