...
$tot = "SELECT  COUNT(complaint_id)  FROM complaints WHERE  state='Pending'";
...
<div class="row " style="margin-top: -10px;">
  ...
  <div class="mt-2 mb-2">
      <span  style="font-size: 20px;font-weight: bold;"><i class="fa fa-plus-circle" aria-hidden="true"></i> &nbsp;New Complaints (<?php echo $InqTot?>)</span>
  <span class="float-right">Complaint Portal &nbsp;&nbsp; <i class="fa fa-arrow-right" aria-hidden="true"></i>  &nbsp;&nbsp;New Complaints</span>
  </div>
    </div>
</div>
...
<br>
        <table id="myTable" class="table table-hover text-center table-striped">
            ...
            $sql = "SELECT complaint_id,title,created_at FROM complaints WHERE state='Pending' ";
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="View-Complaint.php?complaint_id=<?php echo $row['complaint_id'] ?>" style="text-decoration: none;">
                            <span class="btn btn-info mt-1"> View&nbsp;<i class="fa fa-info-circle" aria-hidden="true"></i></span>
                        </a>

                        <a href="inquire.php?complaint_id=<?php echo $row['complaint_id'] ?>" style="text-decoration: none;">
                        <span class="btn btn-secondary mt-1 "> Inquire&nbsp;<i class="fa fa-comments" aria-hidden="true"></i></span>
                        </a>

                        <?php if ($InqCount > 0) { ?>
                            
                            &nbsp;&nbsp;
                            <a href="inquire.php?complaint_id=<?php echo $row['complaint_id']?>&action=seen" id="button">
