...
<div class="col-12">
<a href="complaint_portal/home_complaints.php" style="text-decoration: none;">
  
        <div class="card  mx-1 " style="background-color: #2522af; color: #fff;  box-shadow: 2px 2px 10px #DADADA; border-radius: 5px;">
    ...
    <div class="col-md-6 mx-auto mt-3 mr-3">
        <div class="row">
            <div class="col-12">
                <a href="financial_aid/financial_aid_home.php" style="text-decoration: none;">
...
<div class="row mt-4">
    <div class="col-md-6">
        <a href="survivor_stories/storiesq.php" style="text-decoration: none;">
    ...
    <div class="col-md-6">
        <a href="financial_aid/donors.php" style="text-decoration: none;">
