        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="financial_aid_home.php">&nbsp;&nbsp;Home</a></li>
              <li class="nav-item"> <a class="nav-link" href="pending-applications.php">&nbsp;&nbsp;New Applications</a></li>
                <li class="nav-item"> <a class="nav-link" href="ongoing-applications.php">&nbsp;&nbsp;Ongoing Applications</a></li>
