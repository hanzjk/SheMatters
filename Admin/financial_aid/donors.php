...
$tot = "SELECT  COUNT(donator_id)  FROM donations ";
$result_tot = mysqli_query($link, $tot);
$inq_tot = mysqli_fetch_assoc($result_tot);
$InqTot = $inq_tot["COUNT(donator_id)"];
...
<div class="row " style="margin-top: -10px;">
    ...
    <div class="col-12 card comp " style="outline: none;border: none;">
        ...
        <div class="mt-2 mb-2">
            <span style="font-size: 20px;font-weight: bold;"><i class="fa fa-users" aria-hidden="true"></i> &nbsp;Donors (<?php echo $InqTot ?>)</span>
            <span class="float-right">Financial Aid Portal &nbsp;&nbsp; <i class="fa fa-arrow-right" aria-hidden="true"></i> &nbsp;&nbsp;Donors</span>
        </div>
    </div>
</div>
    ...
    <div class="col-12 mx-auto comp table-responsive">
        ...
        <table id="myTable" class="table table-hover text-center table-striped">
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                $sql1 = "SELECT * FROM users WHERE id='" . $row['donator_id']  . "'";
            ...
            ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php $result_P = $link->query("SELECT photo FROM users WHERE  id='" . $row['donator_id'] . "'");
                    ...
                    <td>
                        ...
                        <?php
                        echo date('d M Y H:i:s', strtotime($row['donated_on']));

                        ?>

                    </td>
                    <td>
                    <a href="View-Application.php?application_id=<?php echo $row['application_id'] ?>" style="text-decoration: none;">
