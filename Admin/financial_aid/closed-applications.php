...
$tot = "SELECT  COUNT(application_id)  FROM applications WHERE  state='Closed'";
...
<div class="row " style="margin-top: -10px;">
    ...
    <div class="col-12 card comp " style="outline: none;border: none;">
        ...
        <div class="mt-2 mb-2">
            <span style="font-size: 20px;font-weight: bold;"><i class="fa fa-check-square-o" aria-hidden="true"></i> &nbsp;Closed Applications (<?php echo $InqTot ?>)</span>
            <span class="float-right">Financial Aid Portal &nbsp;&nbsp; <i class="fa fa-arrow-right" aria-hidden="true"></i> &nbsp;&nbsp;Closed Applications</span>
        </div>
    </div>
</div>
...
<div class="row mt-3" style="background-color:#fff;  border: 1px solid #e8eef1;">
    ...
    <div class="col-12 mx-auto comp">
        ...
        <table id="myTable" class="table table-hover text-center table-striped">
            ...
            $sql = "SELECT application_id,applicant_id,created_at FROM applications WHERE state='Closed' ";
            ...
            ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="View-Application.php?application_id=<?php echo $row['application_id'] ?>&action=closed" style="text-decoration: none;">
