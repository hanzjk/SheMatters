...
$tot = "SELECT  COUNT(application_id)  FROM applications WHERE  state='Rejected'";
...
<div class="row " style="margin-top: -10px;">
    ...
    <div class="col-12 card comp " style="outline: none;border: none;">
        ...
        <div class="mt-2 mb-2">
            <span style="font-size: 20px;font-weight: bold;"><i class="fa fa-times-circle-o" aria-hidden="true"></i> &nbsp;Rejected Applications (<?php echo $InqTot ?>)</span>
            <span class="float-right">Financial Aid Portal &nbsp;&nbsp; <i class="fa fa-arrow-right" aria-hidden="true"></i> &nbsp;&nbsp;Rejected Applications</span>
        </div>
    </div>
</div>
...
<div class="row mt-3" style="background-color:#fff;  border: 1px solid #e8eef1;">
    ...
    <div class="col-12 mx-auto comp">
        ...
        <table id="myTable" class="table table-hover text-center table-striped">
            ...
            $sql = "SELECT application_id,applicant_id,created_at FROM applications WHERE state='Rejected' ";
            ...
            ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="View-Application.php?application_id=<?php echo $row['application_id'] ?>&action=rejected" style="text-decoration: none;">
