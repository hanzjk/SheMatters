    ...
    <div class="page-wrapper">
        ...
        <header class="main-header">
                ...
                <div class="auto-container">
                    <div class="wrapper-box">
                        <div class="logo-column">
                            <div class="logo-box">
                            <div class="logo"><a href="../user/home.php"><img src="assets/main/images/logo2.png"  style="height: 100px;" alt="" title=""></a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="nav-outer">
                                    ...
                                    <nav class="main-menu navbar-expand-xl navbar-dark">
                                        ...
                                        <div class="collapse navbar-collapse">
                                            <ul class="navigation">
                                                <li class="current" style="font-weight: bold;"><a href="home.php">Admininstrator Login</a></li>
            ...
            <div class="mobile-menu style-one">
                <div class="menu-box">
                    <div class="logo"><a href="../user/home.php">
