                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="#" data-toggle="modal" data-target="#myModal" style="text-decoration: none;">
                            <span class="btn btn-success mt-1 " data-id="<?php echo $row['story_id']?>" id="approve"> Approve&nbsp;<i class="fa fa-check" aria-hidden="true"></i></span>
                        </a>

                        <a href="#" data-toggle="modal" data-target="#myModal1" style="text-decoration: none;">
                            <span class="btn btn-danger mt-1" data-id="<?php echo $row['story_id']?>" id="reject" > Reject&nbsp;<i class="fa fa-close" aria-hidden="true"></i></span>
                        </a>
