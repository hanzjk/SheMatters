...
$tot = "SELECT  COUNT(complaint_id)  FROM complaints WHERE  state='Closed' AND police_id='" . $police_id . "'";
...
<div class="row " style="margin-top: -10px;">
    ...
    <div class="col-12 card comp " style="outline: none;border: none;">
        ...
        <div class="mt-2 mb-2">
            <span style="font-size: 20px;font-weight: bold;"><i class="fa fa-check-square-o" aria-hidden="true"></i> &nbsp;Closed Complaints (<?php echo $InqTot ?>)</span>
            <span class="float-right">Complaint Portal &nbsp;&nbsp; <i class="fa fa-arrow-right" aria-hidden="true"></i> &nbsp;&nbsp;Closed Complaints</span>
        </div>
    </div>
</div>
...
<div class="row mt-3" style="background-color:#fff;  border: 1px solid #e8eef1;">
    ...
    <div class="col-12 mx-auto comp table-responsive">
        ...
        <table id="myTable" class="table table-hover text-center table-striped">
            ...
            $sql = "SELECT complaint_id,title,created_at FROM complaints WHERE state='Closed' AND police_id='" . $police_id . "'";
            $result = mysqli_query($con, $sql);
            $count = 0;

            while ($row = mysqli_fetch_array($result)) {
                $sql2 = "SELECT closed_date FROM police_complaints WHERE complaint_id='" . $row['complaint_id'] . "'";
            ...
            ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php
                        echo date('d M Y H:i:s', strtotime($rowd['closed_date']));
                    ...
                    <td>
                        ...
                        <a href="View-Only-Complaint.php?complaint_id=<?php echo $row['complaint_id'] ?>" style="text-decoration: none;">
