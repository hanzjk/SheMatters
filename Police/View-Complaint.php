...
<button class="btn btn-success col-12" data-toggle="modal" data-target="#myModal" >Confirm the receipt of Complaint </button> 
</div>
    ...
    <div class="modal-dialog modal-confirm ">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <h4>Please confirm the receival of the complaint</h4>
                <a href="confirm.php?complaint_id=<?php echo $row['complaint_id'] ?>"><button class="btn btn-success" style="background-color:#01796f;">Confirm</button></a>
