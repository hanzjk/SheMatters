...
$tot = "SELECT  COUNT(complaint_id)  FROM complaints WHERE  state='Ongoing' AND police_id='".$police_id."'";
...
<br>
        <table id="myTable" class="table table-hover text-center table-striped">
            ...
            $sql = "SELECT complaint_id,title,created_at FROM complaints WHERE state='Ongoing' AND police_id='".$police_id."'";
