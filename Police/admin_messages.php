...
<div class="col-12 card comp " style="outline: none;border: none;">
    ...
    <div class="mt-2 mb-2">
        <span style="font-size: 20px;font-weight: bold;"><i class="fa fa-user" aria-hidden="true"></i> &nbsp;Messages from administrator </span>
    </div>
</div>
</div>
                    ...
                    <div class="chat_container" >
                        <div class="job-box" style="border: none;">
                            ...
                            <div class="inbox-message">
                                ...
                                $sql = "SELECT *  FROM admin_message_police WHERE police_id='" . $police_id . "' ";
                                    ...
                                    <ul>
                                        <li>
                                            <div class="message-avatar">
                                                <img src="../user/assets/images/admin.jpg" alt="">
                                            </div>
                                                ...
                                                <div class="message-body-heading">
                                                    ...
                                                    <?php if ($row['reply'] === NULL) { ?>
                                                        <h5> <span class="unread">Unread</span>
                                                            <a href="#" data-toggle="modal" data-target="#myModal" data-id="<?php echo $row['msgID'] ?>" id="getID"><span class="reply">Reply</span></a>
                                                        </h5>
                                                    <?php } else { ?>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header" style="background-color: rgb(48, 44, 81);">
                <h4 class="modal-title" style="color: white;">Message Info</h4>
            </div>
        ...
        <div class="modal-content">
            ...
            <form id="reply_form">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="message" style="font-weight: bold;">Reply Message</label>
...
<script>
    ...
    $('#myModal_reply').on('show.bs.modal', function(e) {
        ...
        $.ajax({
            type: 'post',
            url: 'inquiry_police_action.php', //Here you will fetch records 
