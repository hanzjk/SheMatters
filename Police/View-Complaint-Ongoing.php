...
<div class="row float-right">
    <a href="additional_details.php?complaint_id=<?php echo $row['complaint_id'] ?>">
...
<button class="btn btn-danger col-12" data-toggle="modal" data-target="#myModal" >Close the complaint </button> 
</div>
    ...
    <div class="modal-dialog modal-confirm">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <a href="close.php?complaint_id=<?php echo $row['complaint_id'] ?>"><button class="btn " style="background-color: #800020;">Close</button></a>
